<!DOCTYPE html>
<html lang="es-ve" dir="ltr" class="no-js">
<!--<![endif]-->
...
<head>
    ...
    <!-- deben ser el 3% del contenido que hay en la pagina-->
    <meta name="keywords" content="Programador Web, Desarrollador de software" />
    <!---->
    <meta name="description" content="Desarrollador web FullStack" />
    <!---->
    <meta name="author" content="gabrielarzola.com" />
    <!---->
    <meta name="owner" content="Gabriel Arzola Fumero" />
    <!---->
    ...
    <!-- GOOGLE FONTS                              -->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:800,600" rel="stylesheet" />
    ...
    <style>
        ...
        .parallax3 {
            /* The image used */
            background-image: url("assets/img/coffe.jpg");
            /* Set a specific height */
            /* Create the parallax scrolling effect */
            background-attachment: fixed;
            background-position: center;
...
<body id="body" class="wide-layout preloader-active">
    ...
    <div id="pageWrapper" class="page-wrapper">
        <header class="main-header">
            ...
            <div class="navbar navbar-default" role="navigation">
              ...
              <span class="icon-bar"></span>
                        ...
                        <a class="navbar-brand t-uppercase" href="index-2.html">Gabriel <span class="color-green">Arzola</span></a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right centro">
                            <li class="active">
                                <a class="page-scroll" href="#body" title="Home">Inicio</a>
                            </li>
                            <li>
                                <a class="page-scroll" href="#habilidades" title="Experiences">Habilidades</a>
                            </li>
                            <li>
                                <a class="page-scroll" href="#experience_area" title="Experiences">Experiencia</a>
                            </li>
                            <li>
        ...
        <main id="mainContent" class="main-content">
            <div class="page-container">
                <section class="section hero-area t-center parallax" id="home" data-bg-img="assets/img/write.jpg">
                    <div class="container">
                        <div class="hero-content mb-30">
                            <h2>Hola! Soy</h2>
                            <h1 class="mb-10 font-80">Gabriel Arzola</h1>
                            <h3>
                                <span class="typed-text" data-text1="Programador Web" data-text2="Diseñador de productos digitales" data-text3="Scrum Master" data-loop="true" data-backdelay="3000"></span>
                            </h3>
                        </div>
                        <div class="hero-buttons mb-40">
                            <button class="btn btn-lg btn-rounded hire-me-btn page-scroll">
                <a class="page-scroll color-white" href="#contacto">Contactame</a>
              </button>
                        </div>
                    </div>
                </section>

                <section class="wow fadeInLeft" data-wow-delay="0.4s" style="background-color: #f5f5f5">
                    <div class="container pt-80">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="profile-img mb-15 contenedor">
                                    <img src="assets/img/yo.jpg" alt="" class="imagen" />
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="profile-info">
                                    ...
                                    <p class="color-mid">
                                        Desarrollador web con 6 años de experiencia en distintos tipos de proyectos y responsabilidades. Creador de productos digitales desde la conceptualización hasta la puesta en producción del proyecto.
                                    </p>

                                    <p class="color-mid">
                                        Actualmente me enfoco en la creación de sitios web, Ecommerce y en el desarrollo de sistemas basados en Django.
                                    </p>

                                    <p class="color-mid">
                                        También tengo amplia experiencia en el asesoramiento de pequeñas y medianas empresas en la transición tecnológica que necesitan para adaptarse a los nuevos cambios que se presentan en el comercio.
                                    </p>
                ...
                <section class="section my-skills-area clearfix pb-30" id="habilidades">
                    <div class="container">
                        <div class="row pb-60 wow fadeInLeft" data-wow-delay="0.4s" style="padding: 3%">
                            <div class="col-lg-7 col-md-8 col-sm-10 col-xs-12 col-xs-center t-center">
                                <h2 class="mb-20 font-24 t-uppercase" data-wow-delay="0.4s">
                                    Habilidades
                                </h2>
                            </div>
                        </div>
                        <div class="row row-tb-15">
                            <ul class="skills-list col-md-6 wow fadeInLeftBig" data-wow-delay="0.3s" data-wow-duration="1s">
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                            <img src="assets/iconos/HTML5.svg" alt="HTML5" width="80" height="80" />
                                        </div>
                                ...
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-md-2">
                                            <img src="assets/img/ionic_logo.svg" width="80" height="80" />
                                        </div>
                                        <div class="col-md-10">
                                            <h6>IONIC</h6>
                                        </div>
                                ...
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-md-2">
                                            <img src="assets/iconos/UX.png" alt="HTML5" width="80" height="80" />
                                        </div>
                                        <div class="col-md-10">
                                            <h6>UX / UI</h6>
                                        </div>
                            ...
                            <ul class="skills-list col-md-6 wow fadeInRightBig" data-wow-delay="0.3s" data-wow-duration="1s">
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-md-2">
                                            <img src="assets/iconos/django.png" alt="HTML5" width="80" height="80" />
                                        </div>
                                        <div class="col-md-10">
                                            <h6>Python / Django</h6>
                                        </div>
                                ...
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-md-2">
                                            <img src="assets/iconos/laravel.png" alt="HTML5" width="80" height="80" />
                                        </div>
                                        <div class="col-md-10">
                                            <h6>Php / Laravel</h6>
                                        </div>
                                ...
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-md-2">
                                            <img src="assets/iconos/wordpress.png" alt="HTML5" width="80" height="80" />
                                        </div>
                                        <div class="col-md-10">
                                            <h6>WordPress / Woocomerce</h6>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-md-2">
                                            <img src="assets/iconos/SEO.png" alt="HTML5" width="80" height="80" />
                                        </div>
                                        <div class="col-md-10">
                                            <h6>SEO</h6>
                                        </div>
                                ...
                                <li>
                                    <div class="row centro sep">
                                        <div class="col-md-2">
                                            <img src="assets/iconos/mysql2.png" alt="HTML5" width="80" height="80" />
                                        </div>
                                        <div class="col-md-10">
                ...
                <section class="section get-quote-area ptb-80 parallax2">
                    <div class="row">
                        <div class="col-md-12 verlink wow zoomIn" data-wow-delay="0.3s" data-wow-duration="1s">
                            <div class="get-quotes-content text-center color-white row">
                                <div class="col-lg-7 col-md-8 col-sm-10 col-xs-center">
                                    ...
                                    <h6 class="mb-40">
                                        Todos tenemos una idea de negocio la cual queremos llevar a cabo, trabajemos juntos para encontrar la mejor manera de realizarla, Tu pones la idea, Yo el codigo!.
                                    </h6>
                                </div>
                            </div>
                        </div>
                ...
                <section class="section experience-area ptb-60" id="experience_area">
                    <div class="container wow fadeInLeft" data-wow-delay="1s">
                        <div class="row mb-20">
                            <div class="
                    col-lg-7 col-md-8 col-sm-10 col-xs-12 col-xs-center
                    t-center
                    mb-40
                  ">
                                <h2 class="mb-20 font-24 t-uppercase">
                                    Experiencia de trabajo
                                </h2>
                                <p class="color-mid">
                                    Mi experiencia de trabajo como desarrollador en distintos entes del estado y empresas privadas
                                </p>
                            </div>
                        </div>
                        <div class="row row-tb-15">
                                ...
                                <a href="http://www.itssca.net/" target="_black">
                                    <div class="experience-single">
                                        ...
                                        <div class="experience-content">
                                            ...
                                            <p class="color-mid">
                                                Programador Movil y Consultor de seguridad
                                            </p>
                                        </div>
                                    </div>
                                </a>
                ...
                <section class="section education-area ptb-60" id="education_area">
                    <div class="container">
                        <div class="row mb-20">
                            <div class="
                    col-lg-7 col-md-8 col-sm-10 col-xs-12 col-xs-center
                  ...
                  ">
                                ...
                                <p class="color-mid">
                                    Información sobre mi carrera y los cursos realizados a lo largo de mi trayectoria como programador.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="timeline-block row row-rl-0 mtb-20 mtb-md-10">
                                <div class="timeline-block-wrapper col-md-6 col-sm-12">
                                    <div class="timeline-content">
                                        ...
                                        <p class="color-mid">
                                            Curso realizado en Platzi, sobre el desarrollo con tecnologías para el desarrollo web con: HTML5, CSS3, y Javascript
                                        </p>
                                        <a href="https://platzi.com/@fumeromj/html5-css3/diploma/" target="_black" class="verlink">Ver
                      certificado</a>
                                    </div>
                                </div>
                                <span class="timeline-date">Web</span>
                            </div>
                            <div class="timeline-block row row-rl-0 mtb-20 mtb-md-10">
                                <div class="
                      timeline-block-wrapper
                      col-md-6 col-md-offset-6 col-sm-12
                    ">
                                    <div class="timeline-content">
                                        <h6 class="t-uppercase mb-10">Responsive Web Desing</h6>
                                        <p class="color-mid">
                                            Curso realizado en Platzi, este curso se basa en las bases necesarias para realizar una web responsive para dispositivos de distintas resoluciones de pantallas como también para pantallas de retina.
                                        </p>
                            ...
                            <div class="timeline-block row row-rl-0 mtb-20 mtb-md-10">
                                <div class="timeline-block-wrapper col-md-6 col-sm-12">
                                    <div class="timeline-content">
                                        <h6 class="t-uppercase mb-10">
                                            Diseño de productos con enfoque UX
                                        </h6>
                                        <p class="color-mid">
                                            Curso realizado en Platzi, este curso se basa en las bases necesarias para realizar una web responsive para dispositivos de distintas resoluciones de pantallas como también para pantallas de retina.
                                        </p>
                                ...
                                <span class="timeline-date">Diseño de productos</span>
                            </div>
                            <div class="timeline-block row row-rl-0 mtb-20 mtb-md-10">
                                <div class="
                      timeline-block-wrapper
                    ...
                    ">
                                    <div class="timeline-content">
                                        ...
                                        <p class="color-mid">
                                            Curso enfocado al desarollo aplicaciones Single Page Aplication con Angular 4
                                        </p>
                                        <a href="https://platzi.com/@fumeromj/curso/angular/diploma/" target="_black" class="verlink">Ver
                      certificado</a>
                                    </div>
                                </div>
                                <span class="timeline-date">Web</span>
                            ...
                            <div class="timeline-block row row-rl-0 mtb-20 mtb-md-10">
                                <div class="timeline-block-wrapper col-md-6 col-sm-12">
                                    <div class="timeline-content">
                                        ...
                                        <p class="color-mid">
                                            Curso enfocado al desarrollo de aplicaciones hibridas con el framework IONIC, usando Angular 5 como framework de apoyo JS
                                        </p>
                    ...
                    ">
                                    <div class="timeline-content">
                                        ...
                                        <p class="color-mid">
                                            Curso realizado en Udemy, sobre el uso y desarrollo de sistemas de información usando unos de los frameworks más importantes en el mundo de PHP. Symfony
                                        </p>
                                        <a href="https://www.udemy.com/certificate/UC-7FR96OIQ/" target="_black" class="verlink">Ver
                      certificado</a>
                                    </div>
                                </div>
                                <span class="timeline-date">Web</span>
                            ...
                            <div class="timeline-block row row-rl-0 mtb-20 mtb-md-10">
                                <div class="timeline-block-wrapper col-md-6 col-sm-12">
                                    <div class="timeline-content">
                                        ...
                                        <p class="color-mid">
                                            Curso realizado en Miriadax, sobre el enfoque de las metodologías ágiles y las ventajas que nos brindan en el desarrollo de un producto y la administración de su equipo.
                                        </p>
                                ...
                                <span class="timeline-date">Gestion de proyectos</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="section education-area ptb-60" id="portafolio_area">
                  ...
                  ">
                        ...
                        <a href="https://anitakatz.com/" target="_black" class="" style="color: #fff">Ver mas</a>
                      </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="card-container">
                                        ...
                                        <div class="t-center">
                                            <button class="btn btn-lg btn-rounded hire-me-btn">
                        <a href="http://bithonor.io/" target="_black" class="" style="color: #fff">Ver mas</a>
                      </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="section hero-area contact-us-area ptb-60 parallax3" id="contacto">
                    <div class="container">
                        <div class="row mb-40">
                            <div class="
                    col-lg-7 col-md-8 col-sm-10 col-xs-12 col-xs-center
                    t-center
                  ">
                                <h2 class="mb-20 font-24 t-uppercase color-white">
                                    Contactame
                                </h2>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="color-white">
                                    <h3 class="mb-10 text-center">
                                        Contactame via correo electrónico
                                    </h3>
                                    <p class="color-white mb-30">
                                        La comunicación contigo es fundamental
                                    </p>
                                    <form id="formulario" method="post">
                                        <div class="row row-tb-10">
                                            ...
                                            <div class="col-xs-12">
                                                <button class="btn btn-block" id="botonenviar" type="submit">
                          Enviar mensaje
                        </button>
                                            </div>
                            ...
                            <div class="col-md-5 col-md-offset-1">
                                <div class="" style="padding-bottom: 7%">
                                    ...
                                    <p class="color-white mb-30">
                                        Si quieres contactarme para consultas, asesorías o proyectos que tengas en mente puedes hacerlo por estas vías.
                                    </p>
                                    <ul class="contact-list mb-30">
                                        ...
                                        <li>
                                            ...
                                            <h6>Telefono</h6>
                                            <p class="color-white">(+58) 0412-724-3202</p>
                                        </li>
                                        <li>
                                            <!--i class="glyphicons glyphicons-message-plus"></i-->
                                            <h6>Skype</h6>
                                            <p class="color-white">gabriel_isaias</p>
                                        </li>
                                        <li>
                                            <!--i class="glyphicons glyphicons-message-plus"></i-->
                                            <h6>Linkdin</h6>
                                            <p class="color-white">
                                                www.linkedin.com/in/gabrielarzola-programador/
                                            </p>
                                        </li>
                                    </ul>
                                </div>
    ...
    <!-- jQuery Appear -->
    <script type="text/javascript" src="assets/vendors/jquery.appear.js"></script>

    <!-- Typed.js -->
    <script type="text/javascript" src="assets/vendors/typed.js"></script>
